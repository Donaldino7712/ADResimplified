...
export const ecTimeStudies = [
  {
    ...
    secondary: {
      ...
      required: completions => new Decimal(15000 + Math.min(completions, Enslaved.isRunning ? 999 : 4) * 15000),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => 800 + Math.min(completions, 4) * 100,
      formatValue: formatInt
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => new Decimal(12000 + Math.min(completions, 4) * 1000),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E250000.pow(Math.min(completions, 4)).times(DC.E300000),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E1000.pow(Math.min(completions, 4)).times(DC.E14000),
      formatValue: value => format(value)
    }
  },
  {
